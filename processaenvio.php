<?php
  ...
  $headers .= "X-Sender:  <contato@tryaderh.com.br>\r\n"; //email do servidor //que enviou
  $headers .= "From: $email";
 
 
  $headers .= "Return-Path:  <contato@tryaderh.com.br>\r\n"; //caso a msg //seja respondida vai para  este email.
  $envio = mail("contato@tryaderh.com.br",$email,$corpo, $headers);
...
<body>
    ...
    <div id="fundo-preto">
        <div class=" container">
            <div class="padding text-center">
                   <h1  style="color:white;margin-top:100px;">Esta mensagem não pode ser enviada!!!</h1>
                   <strong>Em breve responderemos</strong>
            </div>
        </div>
    </div>
